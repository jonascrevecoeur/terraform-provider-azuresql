...
func BuildTestData(t *testing.T) TestData {
	testData := TestData{
		...
		SynapseDedicatedServer_connection:   fmt.Sprintf("synapsededicated::%s:%s", os.Getenv("AZURE_SYNAPSE_DEDICATED_SERVER"), os.Getenv("AZURE_SYNAPSE_DEDICATED_SERVER_PORT")),
		SynapseDedicatedDatabase_connection: fmt.Sprintf("synapsededicated::%s:%s:%s", os.Getenv("AZURE_SYNAPSE_DEDICATED_SERVER"), os.Getenv("AZURE_SYNAPSE_DEDICATED_SERVER_PORT"), os.Getenv("AZURE_SYNAPSE_DEDICATED_DATABASE")),
