...
- `default_schema` (Optional, String) ID of the `azuresql_schema` used as the user's default schema. This option is available for database users. When not set, SQL Server uses `dbo` as the default schema.
